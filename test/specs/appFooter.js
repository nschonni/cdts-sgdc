...
describe( "AppFooter section tests for GCWeb", () => {
    ...
    it( "Footer brand links should not open in new window", async() => {
...
async function footerLinks( theme, lang ) {
    ...
    if ( lang == "en" ) {
 await expect( appFooterPage.footerLinkNewWinSpan ).toHaveTextContaining( "This link will open in a new window" );
} else {
 await expect( appFooterPage.footerLinkNewWinSpan ).toHaveTextContaining( "Ce lien ouvrira dans une nouvelle fenêtre" );
}
}
...
async function footerLinksIntranet( theme, lang ) {
    ...
    if ( lang == "en" ) {
 await expect( appFooterPage.footerLinkNewWinSpanIntranet ).toHaveTextContaining( "This link will open in a new window" );
} else {
 await expect( appFooterPage.footerLinkNewWinSpanIntranet ).toHaveTextContaining( "Ce lien ouvrira dans une nouvelle fenêtre" );
}
}
...
async function footerLinksGlobal( theme, lang ) {
    ...
    await expect( appFooterPage.footer ).toExist();
    if ( lang === "en" ) {
 await expect( appFooterPage.footerLink ).toHaveTextContaining( "News" );
} else {
 await expect( appFooterPage.footerLink ).toHaveTextContaining( "Nouvelles" );
}
}
...
async function footerShowFeatures( theme, lang ) {
    await appFooterPage.open( theme, lang );
    if ( lang == "en" ) {
 await expect( footerPage.footerFeatures ).toHaveTextContaining( "Activities and initiatives" );
} else {
 await expect( footerPage.footerFeatures ).toHaveTextContaining( "Activités et initiatives" );
}
}
...
async function customFooterLinksSubTheme( theme, lang, page ) {
    ...
    await expect( appFooterPage.customFooterLink ).toHaveAttributeContaining( "target", "_blank" );
    if ( lang == "en" ) {
 await expect( appFooterPage.customFooterLinkTextSubTheme ).toHaveTextContaining( "Corporate" );
} else {
 await expect( appFooterPage.customFooterLinkTextSubTheme ).toHaveTextContaining( "Ministère" );
}
}
...
async function customFooterLinksECCC( theme, lang ) {
    ...
    await expect( appFooterPage.customFooterLink ).toHaveAttributeContaining( "target", "_blank" );
    if ( lang == "en" ) {
 await expect( appFooterPage.customFooterLinkTextSubTheme ).toHaveTextContaining( "Contact Us" );
} else {
 await expect( appFooterPage.customFooterLinkTextSubTheme ).toHaveTextContaining( "Communiquez avec nous" );
}
}
