...
async function settingsBtnExists( theme, lang ) {
    ...
    if ( lang === "en" ) {
 await expect( appTopPage.settingsBtn ).toHaveTextContaining( "Account settings" );
} else {
 await expect( appTopPage.settingsBtn ).toHaveTextContaining( "Paramètres du compte" );
}
}
...
async function signinBtnExists( lang ) {
    ...
    if ( lang === "en" ) {
 await expect( appTopPage.signinBtn ).toHaveTextContaining( "Sign in" );
} else {
 await expect( appTopPage.signinBtn ).toHaveTextContaining( "Ouvrir une session" );
}
}
...
async function signOutBtnExists( lang ) {
    ...
    if ( lang === "en" ) {
 await expect( appTopPage.signOutBtn ).toHaveTextContaining( "Sign out" );
} else {
 await expect( appTopPage.signOutBtn ).toHaveTextContaining( "Fermer la session" );
}
}
...
async function signinBtnExistsIntranet( lang ) {
    ...
    if ( lang === "en" ) {
 await expect( appTopPage.signOffBtnIntranet ).toHaveTextContaining( "Sign in" );
} else {
 await expect( appTopPage.signOffBtnIntranet ).toHaveTextContaining( "Connexion" );
}
}
...
async function signOutBtnExistsIntranet( lang ) {
    ...
    if ( lang === "en" ) {
 await expect( appTopPage.signOffBtnIntranet ).toHaveTextContaining( "Sign out" );
} else {
 await expect( appTopPage.signOffBtnIntranet ).toHaveTextContaining( "Déconnexion" );
}
}
...
async function signinBtnDoesNotExist( theme, lang ) {
    await basicPage.open( theme, lang, "app" );
    if ( theme === "gcweb" ) {
 await expect( appTopPage.signinBtn ).not.toExist();
} else {
 await expect( appTopPage.signOffBtnIntranet ).not.toExist();
}
}
...
async function testAppName( theme, lang ) {
    await appTopPage.open( theme, lang );
    if ( lang == "en" ) {
 await expect( appTopPage.appNameH2 ).toHaveTextContaining( "Name of Web application" );
} else {
 await expect( appTopPage.appNameH2 ).toHaveTextContaining( "Nom de l'application Web" );
}
