...
class SplashPage extends Page {
 ...
 return $( "a.btn-default" );
    ...
    get enTermLink() {
 return $( "div.col-xs-7 a:nth-of-type(1)" );
}
    get frTermLink() {
 return $( "div.col-xs-7 a:nth-of-type(2)" );
}
    get enContent() {
 return $( "div.cdts-splash section:first-child h2" );
}
    get frContent() {
 return $( "div.cdts-splash section:last-child h2" );
}
